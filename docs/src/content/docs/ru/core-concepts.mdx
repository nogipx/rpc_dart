...
description: Понимание фундаментальных концепций библиотеки RPC Dart.
---
...
- [Архитектура](/ru/architecture) - Изучите паттерны архитектуры CORD
- [Типы транспортов](/ru/transports/inmemory) - Глубокое погружение в доступные транспорты
- [Паттерны стриминга](/guides/streaming-patterns) - Подробные примеры каждого паттерна RPC
- [Тестирование и инструменты](/guides/testing-and-debugging) - Лучшие практики тестирования RPC приложений
