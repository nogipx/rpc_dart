---
title: Isolate транспорт
description: Высокопроизводительная коммуникация между изолятами с передачей объектов без копирования и поддержкой рабочих процессов для CPU-интенсивных операций.
---
...
<CardGrid>
  <Card title="Передача объектов без копирования" icon="rocket">
