...
Абстрактный базовый класс, который предоставляет стандартную реализацию управления жизненным циклом транспорта:
...
Добавляет поддержку zero-copy операций:
...
Добавляет буферизацию сообщений для оптимизации производительности:
...
Добавляет автоматическое переподключение:
...
Утилиты для сериализации транспортных сообщений в различные форматы:
...
Конвертер метаданных для различных протоколов:
...
Fluent API для создания конфигураций транспортов:
