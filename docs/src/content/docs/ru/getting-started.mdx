...
- Ознакомьтесь с [типами RPC](/ru/rpc-types/unary) для потоковой и двунаправленной коммуникации
- Попробуйте [архитектуру CORD](/ru/cord) для структурирования больших приложений

## Нужна помощь?

- Ознакомьтесь с [FAQ](/ru/faqs) для ответов на частые вопросы
