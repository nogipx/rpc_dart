---
title: Быстрый старт
description: Узнайте, как начать работу с RPC Dart всего за несколько минут.
---
...
- Изучите [Основные концепции](/ru/core-concepts) для понимания архитектуры RPC Dart
- Изучите различные [типы транспортов](/ru/transports/inmemory) для разных случаев использования
- Ознакомьтесь с [паттернами стриминга](/guides/streaming-patterns) для потоковой и двунаправленной коммуникации
- Изучите [маршрутизацию и композицию](/guides/routing-and-composition) для структурирования больших приложений

## Нужна помощь?

- Изучите [гид по обработке ошибок](/guides/error-handling), чтобы быстрее находить ответы на типовые вопросы
