---
title: Context, Metadata & Deadlines
description: Learn how RpcContext keeps metadata, authentication, deadlines, and cancellation together.
---
...
<CardGrid>
  ...
  <Card title="Traceability" icon="rocket">
...
<Tabs>
  ...
  <TabItem label="Inheriting from parent">
