...
description: Real-time bidirectional transport for web applications and cross-platform communication.
---
...
<CardGrid>
  <Card title="Real-time Communication" icon="rocket">
