...
> **Рекомендации по использованию Contract-Oriented Remote Domains**
...
Применение CORD архитектуры с rpc_dart основывается на следующих принципах:
...
CORD - архитектурный подход для приложений с множественными доменами. Для простых CRUD приложений традиционные паттерны могут оказаться более подходящими.
