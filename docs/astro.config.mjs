...
export default defineConfig({
	...
	integrations: [
        ...
        },
        {
                ...
                items: [
                        {
                                label: 'RPC Call Lifecycle',
                                link: '/guides/rpc-lifecycle/',
                        },
                        {
                                label: 'Context & Metadata',
                                link: '/guides/context-and-metadata/',
                        },
                        {
                                label: 'Streaming Patterns',
                                link: '/guides/streaming-patterns/',
                        },
                        {
                        ...
                        },
                        {
                                ...
                                link: '/guides/routing-and-composition/',
                        },
                        {
                                label: 'Testing & Tooling',
                                link: '/guides/testing-and-debugging/',
                        },
                ],
        },
        {
