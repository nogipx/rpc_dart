...
- Добавлена поддержка заголовков запросов и метаданных
- Реализовано управление deadline и timeout
- Добавлены cancellation tokens для отмены операций
- Добавлена поддержка distributed tracing с trace ID и span ID
- Добавлена аутентификация (Basic Auth, Bearer Token, API Key)
- Оптимизирован InMemoryTransport для улучшения производительности
- Удалены избыточные async/await операции
- Оптимизированы подписки на стримы
- Исправлены race conditions и deadlock ситуации
- Добавлена полная поддержка контекста во всех типах RPC методов
- Добавлена передача метаданных в server/client/bidirectional streaming
- Улучшена передача заголовков через все уровни стека
- Улучшена консистентная обработка ошибок и статусов
- Улучшен CI/CD процесс с автоматическим запуском тестов
- Обновлены примеры с демонстрацией RpcContext
- Добавлены примеры аутентификации и трассировки
- Исправлены "гейзенбаги" в тестах производительности CBOR кодировщика
- Оптимизированы лимиты производительности тестов для более стабильной работы
- Улучшена методология измерения времени в тестах через усреднение нескольких прогонов
- Увеличена надежность CI/CD пайплайна за счет устранения ложно-негативных тестов
