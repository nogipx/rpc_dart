...
- **[RPC-05](RPC-05-concurrency-limit-charge-point.md)** confirmed (round 245) — a limit is charged, or released, at the wrong point of the lifecycle; every stateful policy field swept at 215. Round 245 asked WHAT a limit charges instead of where, and found metadata weighing zero against the buffer's byte bound: 256 MiB against a 16 MiB cap; refines U-07
