...
- **[C-32](C-32-rapid-reset-dispatches-nothing.md)** round 277, http2 and core — HTTP/2 Rapid Reset (CVE-2023-44487) dispatches no handler: 0 from 200 resets against 4 from 200 normal calls at `maxActiveStreams: 4`. The cancellation is processed before the pipeline reaches dispatch. **The CPU half is NOT covered** — HPACK decode and stream churn at a rate nothing bounds
