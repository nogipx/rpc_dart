...
mixin _$WebAuthnException {
  WebAuthnExceptionType get type;
  String get message;
  @StackTraceConverter()
  ...
  $WebAuthnExceptionCopyWith<WebAuthnException> get copyWith =>
      _$WebAuthnExceptionCopyWithImpl<WebAuthnException>(
          this as WebAuthnException, _$identity);
...
abstract mixin class $WebAuthnExceptionCopyWith<$Res> {
  factory $WebAuthnExceptionCopyWith(
          WebAuthnException value, $Res Function(WebAuthnException) _then) =
      _$WebAuthnExceptionCopyWithImpl;
  @useResult
  $Res call(
      {WebAuthnExceptionType type,
      String message,
...
class _WebAuthnException extends WebAuthnException {
  const _WebAuthnException(
      {required this.type,
      required this.message,
      @StackTraceConverter() this.stackTrace})
      : super._();
  factory _WebAuthnException.fromJson(Map<String, dynamic> json) =>
      _$WebAuthnExceptionFromJson(json);

  @override
  final WebAuthnExceptionType type;
  @override
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WebAuthnExceptionCopyWith<_WebAuthnException> get copyWith =>
      __$WebAuthnExceptionCopyWithImpl<_WebAuthnException>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$WebAuthnExceptionToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$WebAuthnExceptionCopyWith<$Res>
    implements $WebAuthnExceptionCopyWith<$Res> {
  factory _$WebAuthnExceptionCopyWith(
          _WebAuthnException value, $Res Function(_WebAuthnException) _then) =
      __$WebAuthnExceptionCopyWithImpl;
  @override
  @useResult
  $Res call(
      {WebAuthnExceptionType type,
