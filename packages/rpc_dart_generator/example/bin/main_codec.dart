...
class CalculatorCodecResponder extends CalculatorCodecContractResponder {
  CalculatorCodecResponder({String? serviceName})
...
Future<void> main() async {
  ...
  responderEndpoint.registerServiceContract(
    CalculatorCodecResponder(
      serviceName: CalculatorCodecContractNames.instance('json'),
    ),
  );
  ...
  final caller = CalculatorCodecContractCaller(
    ...
    serviceNameOverride: CalculatorCodecContractNames.instance('json'),
  );
