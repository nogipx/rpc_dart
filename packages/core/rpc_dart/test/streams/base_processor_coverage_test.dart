...
// The processors are off the public barrel; tests reach them here.
    ...
    group('StreamProcessor', () {
      ...
      test(
        ...
        () async {
          ...
          final errors = <Object>[];
          final sub = processor.requests.listen((_) {}, onError: errors.add);
      ...
      test(
        ...
        () async {
          ...
          final errors = <Object>[];
          final sub2 = serialized.requests.listen((_) {}, onError: errors.add);
      ...
      test(
        ...
        () async {
          ...
          final message = await trailers.future.timeout(
    ...
    group('CallProcessor', () {
      ...
      test(
        ...
        () async {
          ...
          final md = await metadataSeen.future.timeout(
            const Duration(seconds: 2),
          );
      ...
      test('cancellation sends cancellation metadata to server', () async {
        ...
        expect(
          msg.metadata?.getHeaderValue(RpcHeaders.xCancellationReason),
          'stop',
        );
      ...
      test(
        ...
        () async {
          ...
          final errors = <Object>[];
          final sub = zeroCopy.responses.listen((_) {}, onError: errors.add);
      ...
      test('serialized response deserialization error path', () async {
        ...
        final errors = <Object>[];
        final sub = processor.responses.listen((_) {}, onError: errors.add);
