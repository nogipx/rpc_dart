...
void main() {
  ...
  test('a span open longer than the sweep interval is NOT force-ended while live',
      () async {
    final t = buildTracer();
    ...
    expect(
      ...
      isEmpty,
      reason: 'A live span within its TTL must not be force-ended mid-flight.',
    );
    ...
    final durationNanos =
        (ended.single.endTime! - ended.single.startTime).toInt();
    const twentyMillisNanos = 20 * 1000 * 1000;
    expect(durationNanos, greaterThan(twentyMillisNanos),
