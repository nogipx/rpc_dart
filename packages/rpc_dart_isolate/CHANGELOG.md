...
- Extracted isolate transports into standalone `rpc_dart_isolate` package.
- Removed WebSocket/HTTP/HTTP2/secure adapter content; only isolate transports remain.
