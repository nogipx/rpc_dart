...
/// [sqlite.CommonDatabase] and passes it to [SqliteBlobRepository.db]. This
/// test only proves the web-facing API compiles to JS without pulling
/// `dart:io` / `dart:ffi`; executing real SQL needs the app to supply
/// `sqlite3mc.wasm`, which is not available here.
void main() {
  ...
  test('web-facing types are reachable and JS-compatible', () {
    ...
    expect(SqliteBlobRepository, isNotNull);
