...
mixin _$ValidateTokenParams {
  String get token;
  WebAuthnAuthContext? get context;

  /// Create a copy of ValidateTokenParams
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ValidateTokenParamsCopyWith<ValidateTokenParams> get copyWith =>
      _$ValidateTokenParamsCopyWithImpl<ValidateTokenParams>(
          this as ValidateTokenParams, _$identity);
...
abstract mixin class $ValidateTokenParamsCopyWith<$Res> {
  factory $ValidateTokenParamsCopyWith(
          ValidateTokenParams value, $Res Function(ValidateTokenParams) _then) =
      _$ValidateTokenParamsCopyWithImpl;
  @useResult
  $Res call({String token, WebAuthnAuthContext? context});
...
class _ValidateTokenParams implements ValidateTokenParams {
  ...
  factory _ValidateTokenParams.fromJson(Map<String, dynamic> json) =>
      _$ValidateTokenParamsFromJson(json);

  @override
  final String token;
  @override
  final WebAuthnAuthContext? context;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ValidateTokenParamsCopyWith<_ValidateTokenParams> get copyWith =>
      __$ValidateTokenParamsCopyWithImpl<_ValidateTokenParams>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ValidateTokenParamsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ValidateTokenParamsCopyWith<$Res>
    implements $ValidateTokenParamsCopyWith<$Res> {
  factory _$ValidateTokenParamsCopyWith(_ValidateTokenParams value,
          $Res Function(_ValidateTokenParams) _then) =
      __$ValidateTokenParamsCopyWithImpl;
  @override
  @useResult
  $Res call({String token, WebAuthnAuthContext? context});
...
mixin _$ValidateTokenResult {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ValidateTokenResultCopyWith<ValidateTokenResult> get copyWith =>
      _$ValidateTokenResultCopyWithImpl<ValidateTokenResult>(
          this as ValidateTokenResult, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, isValid, credential, context, errorMessage, error);
...
abstract mixin class $ValidateTokenResultCopyWith<$Res> {
  factory $ValidateTokenResultCopyWith(
          ValidateTokenResult value, $Res Function(ValidateTokenResult) _then) =
      _$ValidateTokenResultCopyWithImpl;
  @useResult
  $Res call(
      {bool isValid,
...
class _ValidateTokenResult implements ValidateTokenResult {
  _ValidateTokenResult(
      ...
      this.errorMessage,
      this.error});
  factory _ValidateTokenResult.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ValidateTokenResultCopyWith<_ValidateTokenResult> get copyWith =>
      __$ValidateTokenResultCopyWithImpl<_ValidateTokenResult>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ValidateTokenResultToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ValidateTokenResultCopyWith<$Res>
    implements $ValidateTokenResultCopyWith<$Res> {
  factory _$ValidateTokenResultCopyWith(_ValidateTokenResult value,
          $Res Function(_ValidateTokenResult) _then) =
      __$ValidateTokenResultCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool isValid,
...
mixin _$RevokeSessionParams {
  ...
  $RevokeSessionParamsCopyWith<RevokeSessionParams> get copyWith =>
      _$RevokeSessionParamsCopyWithImpl<RevokeSessionParams>(
          this as RevokeSessionParams, _$identity);
...
abstract mixin class $RevokeSessionParamsCopyWith<$Res> {
  factory $RevokeSessionParamsCopyWith(
          RevokeSessionParams value, $Res Function(RevokeSessionParams) _then) =
      _$RevokeSessionParamsCopyWithImpl;
  @useResult
  $Res call({String sessionId, String? reason});
}
...
class _RevokeSessionParams implements RevokeSessionParams {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RevokeSessionParamsCopyWith<_RevokeSessionParams> get copyWith =>
      __$RevokeSessionParamsCopyWithImpl<_RevokeSessionParams>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RevokeSessionParamsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$RevokeSessionParamsCopyWith<$Res>
    implements $RevokeSessionParamsCopyWith<$Res> {
  factory _$RevokeSessionParamsCopyWith(_RevokeSessionParams value,
          $Res Function(_RevokeSessionParams) _then) =
      __$RevokeSessionParamsCopyWithImpl;
  @override
  @useResult
  $Res call({String sessionId, String? reason});
}
...
mixin _$RevokeAllSessionsParams {
  ...
  $RevokeAllSessionsParamsCopyWith<RevokeAllSessionsParams> get copyWith =>
      _$RevokeAllSessionsParamsCopyWithImpl<RevokeAllSessionsParams>(
          this as RevokeAllSessionsParams, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RevokeAllSessionsParams &&
...
abstract mixin class $RevokeAllSessionsParamsCopyWith<$Res> {
  factory $RevokeAllSessionsParamsCopyWith(RevokeAllSessionsParams value,
          $Res Function(RevokeAllSessionsParams) _then) =
      _$RevokeAllSessionsParamsCopyWithImpl;
  @useResult
...
class _RevokeAllSessionsParams implements RevokeAllSessionsParams {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RevokeAllSessionsParamsCopyWith<_RevokeAllSessionsParams> get copyWith =>
      __$RevokeAllSessionsParamsCopyWithImpl<_RevokeAllSessionsParams>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RevokeAllSessionsParamsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RevokeAllSessionsParams &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.reason, reason) || other.reason == reason));
  }
...
/// @nodoc
abstract mixin class _$RevokeAllSessionsParamsCopyWith<$Res>
    implements $RevokeAllSessionsParamsCopyWith<$Res> {
  factory _$RevokeAllSessionsParamsCopyWith(_RevokeAllSessionsParams value,
          $Res Function(_RevokeAllSessionsParams) _then) =
      __$RevokeAllSessionsParamsCopyWithImpl;
  @override
  @useResult
  $Res call({String userId, String? reason});
}
...
mixin _$RevokeSessionResult {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RevokeSessionResultCopyWith<RevokeSessionResult> get copyWith =>
      _$RevokeSessionResultCopyWithImpl<RevokeSessionResult>(
          this as RevokeSessionResult, _$identity);
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, success, revokedCount, message, error);
...
abstract mixin class $RevokeSessionResultCopyWith<$Res> {
  factory $RevokeSessionResultCopyWith(
          RevokeSessionResult value, $Res Function(RevokeSessionResult) _then) =
      _$RevokeSessionResultCopyWithImpl;
  @useResult
  $Res call(
      {bool success,
      int revokedCount,
...
class _RevokeSessionResult implements RevokeSessionResult {
  _RevokeSessionResult(
      ...
      this.message,
      this.error});
  factory _RevokeSessionResult.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RevokeSessionResultCopyWith<_RevokeSessionResult> get copyWith =>
      __$RevokeSessionResultCopyWithImpl<_RevokeSessionResult>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RevokeSessionResultToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$RevokeSessionResultCopyWith<$Res>
    implements $RevokeSessionResultCopyWith<$Res> {
  factory _$RevokeSessionResultCopyWith(_RevokeSessionResult value,
          $Res Function(_RevokeSessionResult) _then) =
      __$RevokeSessionResultCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool success,
...
mixin _$FinishAuthenticationParams {
  String get userId;
  WebAuthnAssertion get assertion;
  String get origin;
  int get expiresIn;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $FinishAuthenticationParamsCopyWith<FinishAuthenticationParams>
      get copyWith =>
          _$FinishAuthenticationParamsCopyWithImpl<FinishAuthenticationParams>(
              this as FinishAuthenticationParams, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FinishAuthenticationParams &&
            (identical(other.userId, userId) || other.userId == userId) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, userId, assertion, origin,
      expiresIn, const DeepCollectionEquality().hash(scopes));

  @override
  String toString() {
    return 'FinishAuthenticationParams(userId: $userId, assertion: $assertion, origin: $origin, expiresIn: $expiresIn, scopes: $scopes)';
  }
}

/// @nodoc
abstract mixin class $FinishAuthenticationParamsCopyWith<$Res> {
  factory $FinishAuthenticationParamsCopyWith(FinishAuthenticationParams value,
          $Res Function(FinishAuthenticationParams) _then) =
      _$FinishAuthenticationParamsCopyWithImpl;
  @useResult
  $Res call(
      {String userId,
...
class _FinishAuthenticationParams implements FinishAuthenticationParams {
  const _FinishAuthenticationParams(
      ...
      : _scopes = scopes;
  factory _FinishAuthenticationParams.fromJson(Map<String, dynamic> json) =>
      _$FinishAuthenticationParamsFromJson(json);

  @override
  final String userId;
  @override
  final WebAuthnAssertion assertion;
  @override
  final String origin;
  @override
  final int expiresIn;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FinishAuthenticationParamsCopyWith<_FinishAuthenticationParams>
      get copyWith => __$FinishAuthenticationParamsCopyWithImpl<
          _FinishAuthenticationParams>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FinishAuthenticationParamsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FinishAuthenticationParams &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.assertion, assertion) ||
                other.assertion == assertion) &&
            (identical(other.origin, origin) || other.origin == origin) &&
  ...
  @override
  int get hashCode => Object.hash(runtimeType, userId, assertion, origin,
      expiresIn, const DeepCollectionEquality().hash(_scopes));
...
/// @nodoc
abstract mixin class _$FinishAuthenticationParamsCopyWith<$Res>
    implements $FinishAuthenticationParamsCopyWith<$Res> {
  factory _$FinishAuthenticationParamsCopyWith(
          _FinishAuthenticationParams value,
          $Res Function(_FinishAuthenticationParams) _then) =
      __$FinishAuthenticationParamsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String userId,
...
mixin _$FinishAuthenticationResult {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $FinishAuthenticationResultCopyWith<FinishAuthenticationResult>
      get copyWith =>
          _$FinishAuthenticationResultCopyWithImpl<FinishAuthenticationResult>(
              this as FinishAuthenticationResult, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FinishAuthenticationResult &&
            (identical(other.success, success) || other.success == success) &&
...
abstract mixin class $FinishAuthenticationResultCopyWith<$Res> {
  factory $FinishAuthenticationResultCopyWith(FinishAuthenticationResult value,
          $Res Function(FinishAuthenticationResult) _then) =
      _$FinishAuthenticationResultCopyWithImpl;
  @useResult
  $Res call(
...
class _FinishAuthenticationResult extends FinishAuthenticationResult {
  const _FinishAuthenticationResult(
      {required this.success, this.authResponse, this.error})
      : super._();
  factory _FinishAuthenticationResult.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FinishAuthenticationResultCopyWith<_FinishAuthenticationResult>
      get copyWith => __$FinishAuthenticationResultCopyWithImpl<
          _FinishAuthenticationResult>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FinishAuthenticationResultToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FinishAuthenticationResult &&
            (identical(other.success, success) || other.success == success) &&
            (identical(other.authResponse, authResponse) ||
                other.authResponse == authResponse) &&
            (identical(other.error, error) || other.error == error));
...
/// @nodoc
abstract mixin class _$FinishAuthenticationResultCopyWith<$Res>
    implements $FinishAuthenticationResultCopyWith<$Res> {
  factory _$FinishAuthenticationResultCopyWith(
          _FinishAuthenticationResult value,
          $Res Function(_FinishAuthenticationResult) _then) =
      __$FinishAuthenticationResultCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool success, AuthResponse? authResponse, WebAuthnException? error});
...
mixin _$FinishRegistrationParams {
  String get userId;
  WebAuthnRegistrationCredential get credential;
  String get origin;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $FinishRegistrationParamsCopyWith<FinishRegistrationParams> get copyWith =>
      _$FinishRegistrationParamsCopyWithImpl<FinishRegistrationParams>(
          this as FinishRegistrationParams, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FinishRegistrationParams &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.credential, credential) ||
                other.credential == credential) &&
            (identical(other.origin, origin) || other.origin == origin));
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, userId, credential, origin);

  @override
  String toString() {
    return 'FinishRegistrationParams(userId: $userId, credential: $credential, origin: $origin)';
  }
}

/// @nodoc
abstract mixin class $FinishRegistrationParamsCopyWith<$Res> {
  factory $FinishRegistrationParamsCopyWith(FinishRegistrationParams value,
          $Res Function(FinishRegistrationParams) _then) =
      _$FinishRegistrationParamsCopyWithImpl;
  @useResult
  $Res call(
      {String userId,
...
class _$FinishRegistrationParamsCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $WebAuthnRegistrationCredentialCopyWith<$Res> get credential {
    return $WebAuthnRegistrationCredentialCopyWith<$Res>(_self.credential,
        (value) {
...
class _FinishRegistrationParams implements FinishRegistrationParams {
  const _FinishRegistrationParams(
      {required this.userId, required this.credential, required this.origin});
  factory _FinishRegistrationParams.fromJson(Map<String, dynamic> json) =>
      _$FinishRegistrationParamsFromJson(json);

  @override
  final String userId;
  @override
  final WebAuthnRegistrationCredential credential;
  @override
  final String origin;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FinishRegistrationParamsCopyWith<_FinishRegistrationParams> get copyWith =>
      __$FinishRegistrationParamsCopyWithImpl<_FinishRegistrationParams>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FinishRegistrationParamsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FinishRegistrationParams &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.credential, credential) ||
                other.credential == credential) &&
            (identical(other.origin, origin) || other.origin == origin));
...
/// @nodoc
abstract mixin class _$FinishRegistrationParamsCopyWith<$Res>
    implements $FinishRegistrationParamsCopyWith<$Res> {
  factory _$FinishRegistrationParamsCopyWith(_FinishRegistrationParams value,
          $Res Function(_FinishRegistrationParams) _then) =
      __$FinishRegistrationParamsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String userId,
...
mixin _$FinishRegistrationResult {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $FinishRegistrationResultCopyWith<FinishRegistrationResult> get copyWith =>
      _$FinishRegistrationResultCopyWithImpl<FinishRegistrationResult>(
          this as FinishRegistrationResult, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FinishRegistrationResult &&
            (identical(other.success, success) || other.success == success) &&
            (identical(other.credential, credential) ||
                other.credential == credential) &&
            (identical(other.error, error) || other.error == error));
...
abstract mixin class $FinishRegistrationResultCopyWith<$Res> {
  factory $FinishRegistrationResultCopyWith(FinishRegistrationResult value,
          $Res Function(FinishRegistrationResult) _then) =
      _$FinishRegistrationResultCopyWithImpl;
  @useResult
  $Res call(
      {bool success,
      WebAuthnCredentialPublic? credential,
...
class _FinishRegistrationResult extends FinishRegistrationResult {
  const _FinishRegistrationResult(
      {required this.success, this.credential, this.error})
      : super._();
  factory _FinishRegistrationResult.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FinishRegistrationResultCopyWith<_FinishRegistrationResult> get copyWith =>
      __$FinishRegistrationResultCopyWithImpl<_FinishRegistrationResult>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FinishRegistrationResultToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FinishRegistrationResult &&
            (identical(other.success, success) || other.success == success) &&
            (identical(other.credential, credential) ||
                other.credential == credential) &&
            (identical(other.error, error) || other.error == error));
...
/// @nodoc
abstract mixin class _$FinishRegistrationResultCopyWith<$Res>
    implements $FinishRegistrationResultCopyWith<$Res> {
  factory _$FinishRegistrationResultCopyWith(_FinishRegistrationResult value,
          $Res Function(_FinishRegistrationResult) _then) =
      __$FinishRegistrationResultCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool success,
...
mixin _$StartAuthenticationParams {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $StartAuthenticationParamsCopyWith<StartAuthenticationParams> get copyWith =>
      _$StartAuthenticationParamsCopyWithImpl<StartAuthenticationParams>(
          this as StartAuthenticationParams, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is StartAuthenticationParams &&
            (identical(other.userId, userId) || other.userId == userId));
  }
...
abstract mixin class $StartAuthenticationParamsCopyWith<$Res> {
  factory $StartAuthenticationParamsCopyWith(StartAuthenticationParams value,
          $Res Function(StartAuthenticationParams) _then) =
      _$StartAuthenticationParamsCopyWithImpl;
  @useResult
...
class _StartAuthenticationParams implements StartAuthenticationParams {
  ...
  factory _StartAuthenticationParams.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$StartAuthenticationParamsCopyWith<_StartAuthenticationParams>
      get copyWith =>
          __$StartAuthenticationParamsCopyWithImpl<_StartAuthenticationParams>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$StartAuthenticationParamsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _StartAuthenticationParams &&
            (identical(other.userId, userId) || other.userId == userId));
  }
...
/// @nodoc
abstract mixin class _$StartAuthenticationParamsCopyWith<$Res>
    implements $StartAuthenticationParamsCopyWith<$Res> {
  factory _$StartAuthenticationParamsCopyWith(_StartAuthenticationParams value,
          $Res Function(_StartAuthenticationParams) _then) =
      __$StartAuthenticationParamsCopyWithImpl;
  @override
  @useResult
  $Res call({String userId});
}
...
mixin _$StartAuthenticationResult {
  AuthenticationOptions? get options;
  WebAuthnException? get error;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $StartAuthenticationResultCopyWith<StartAuthenticationResult> get copyWith =>
      _$StartAuthenticationResultCopyWithImpl<StartAuthenticationResult>(
          this as StartAuthenticationResult, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is StartAuthenticationResult &&
...
abstract mixin class $StartAuthenticationResultCopyWith<$Res> {
  factory $StartAuthenticationResultCopyWith(StartAuthenticationResult value,
          $Res Function(StartAuthenticationResult) _then) =
      _$StartAuthenticationResultCopyWithImpl;
  @useResult
  $Res call({AuthenticationOptions? options, WebAuthnException? error});
...
class _StartAuthenticationResult extends StartAuthenticationResult {
  ...
  factory _StartAuthenticationResult.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$StartAuthenticationResultCopyWith<_StartAuthenticationResult>
      get copyWith =>
          __$StartAuthenticationResultCopyWithImpl<_StartAuthenticationResult>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$StartAuthenticationResultToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _StartAuthenticationResult &&
            (identical(other.options, options) || other.options == options) &&
            (identical(other.error, error) || other.error == error));
  }
...
/// @nodoc
abstract mixin class _$StartAuthenticationResultCopyWith<$Res>
    implements $StartAuthenticationResultCopyWith<$Res> {
  factory _$StartAuthenticationResultCopyWith(_StartAuthenticationResult value,
          $Res Function(_StartAuthenticationResult) _then) =
      __$StartAuthenticationResultCopyWithImpl;
  @override
  @useResult
  $Res call({AuthenticationOptions? options, WebAuthnException? error});
...
mixin _$StartRegistrationParams {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $StartRegistrationParamsCopyWith<StartRegistrationParams> get copyWith =>
      _$StartRegistrationParamsCopyWithImpl<StartRegistrationParams>(
          this as StartRegistrationParams, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is StartRegistrationParams &&
            (identical(other.userId, userId) || other.userId == userId));
  }
  ...
  @override
  String toString() {
    return 'StartRegistrationParams(userId: $userId)';
  }
}

/// @nodoc
abstract mixin class $StartRegistrationParamsCopyWith<$Res> {
  factory $StartRegistrationParamsCopyWith(StartRegistrationParams value,
          $Res Function(StartRegistrationParams) _then) =
      _$StartRegistrationParamsCopyWithImpl;
  @useResult
  $Res call({String userId});
}
...
class _StartRegistrationParams implements StartRegistrationParams {
  const _StartRegistrationParams({required this.userId});
  factory _StartRegistrationParams.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$StartRegistrationParamsCopyWith<_StartRegistrationParams> get copyWith =>
      __$StartRegistrationParamsCopyWithImpl<_StartRegistrationParams>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$StartRegistrationParamsToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _StartRegistrationParams &&
            (identical(other.userId, userId) || other.userId == userId));
  }
...
/// @nodoc
abstract mixin class _$StartRegistrationParamsCopyWith<$Res>
    implements $StartRegistrationParamsCopyWith<$Res> {
  factory _$StartRegistrationParamsCopyWith(_StartRegistrationParams value,
          $Res Function(_StartRegistrationParams) _then) =
      __$StartRegistrationParamsCopyWithImpl;
  @override
  @useResult
  $Res call({String userId});
}
...
mixin _$StartRegistrationResult {
  RegistrationOptions? get options;
  WebAuthnException? get error;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $StartRegistrationResultCopyWith<StartRegistrationResult> get copyWith =>
      _$StartRegistrationResultCopyWithImpl<StartRegistrationResult>(
          this as StartRegistrationResult, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is StartRegistrationResult &&
            (identical(other.options, options) || other.options == options) &&
            (identical(other.error, error) || other.error == error));
  }
...
abstract mixin class $StartRegistrationResultCopyWith<$Res> {
  factory $StartRegistrationResultCopyWith(StartRegistrationResult value,
          $Res Function(StartRegistrationResult) _then) =
      _$StartRegistrationResultCopyWithImpl;
  @useResult
  $Res call({RegistrationOptions? options, WebAuthnException? error});
...
class _StartRegistrationResult extends StartRegistrationResult {
  ...
  factory _StartRegistrationResult.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$StartRegistrationResultCopyWith<_StartRegistrationResult> get copyWith =>
      __$StartRegistrationResultCopyWithImpl<_StartRegistrationResult>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$StartRegistrationResultToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _StartRegistrationResult &&
            (identical(other.options, options) || other.options == options) &&
            (identical(other.error, error) || other.error == error));
  }
...
/// @nodoc
abstract mixin class _$StartRegistrationResultCopyWith<$Res>
    implements $StartRegistrationResultCopyWith<$Res> {
  factory _$StartRegistrationResultCopyWith(_StartRegistrationResult value,
          $Res Function(_StartRegistrationResult) _then) =
      __$StartRegistrationResultCopyWithImpl;
  @override
  @useResult
  $Res call({RegistrationOptions? options, WebAuthnException? error});
