...
- Read-only journal calls no longer materialise collection state, which made
  a read allocate as if it were a write.
- An internal error keeps the cause it captured instead of discarding it.
