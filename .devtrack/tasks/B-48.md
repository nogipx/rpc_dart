---
id: B-48
title: `melos run test:web` is red on the isolate package's Chrome arm
state: done
commit: e897128e
paths: [packages/transport/rpc_dart_isolate/test/**, pubspec.yaml]
evidence: .claude/loop/backlog/archive/B-48-the-isolate-chrome-arm-never-connects.md
blocked_by: 
source: .claude/loop/backlog/archive/B-48-the-isolate-chrome-arm-never-connects.md
---
...
- 0000-00-00 e897128e done — closed (round 379)
