---
id: B-11
title: does an endpoint client reach the connection-pool wedge?
state: done
commit: c48a14d8
paths: [packages/core/rpc_dart/lib/src/endpoint/**, packages/core/rpc_dart/lib/src/rpc/streams/**]
evidence: .claude/loop/backlog/archive/B-11-endpoint-reachability-needs-latency.md
blocked_by: 
source: .claude/loop/backlog/archive/B-11-endpoint-reachability-needs-latency.md
---
...
- 0000-00-00 c48a14d8 done — closed (round 415)
