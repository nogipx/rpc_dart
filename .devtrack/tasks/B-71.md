---
id: B-71
title: a browser WebSocket client cannot detect a half-open path
state: queued
commit: 5674789e
...
evidence: none
blocked_by: 
source: .claude/loop/backlog/B-71-a-browser-websocket-client-cannot-detect-a-half-open-path.md
---
...
- 0000-00-00 5674789e queued — импортировано из evidence-loop, не перемеряно
