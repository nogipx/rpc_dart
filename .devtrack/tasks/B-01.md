---
id: B-01
title: Response metadata is dropped wholesale
state: done
commit: 5bf4d34e
paths: [packages/core/rpc_dart/lib/**]
evidence: .claude/loop/backlog/archive/B-01-response-metadata-dropped.md
blocked_by: 
source: .claude/loop/backlog/archive/B-01-response-metadata-dropped.md
---
...
- 0000-00-00 5bf4d34e done — closed (round 223) — out of the loop, ordinary roadmap work
