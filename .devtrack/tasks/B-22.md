---
id: B-22
title: a consumer that binds and never drains never repays the pool
state: done
commit: af64eeac
paths: [packages/core/rpc_dart/lib/src/rpc/transports/channel_transport.dart]
evidence: .claude/loop/backlog/archive/B-22-paused-consumer-never-repays-the-pool.md
blocked_by: 
source: .claude/loop/backlog/archive/B-22-paused-consumer-never-repays-the-pool.md
---
...
- 0000-00-00 af64eeac done — closed (round 266)
