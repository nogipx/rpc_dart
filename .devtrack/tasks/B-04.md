---
id: B-04
title: isolate: unaudited `Future.timeout` sites
state: done
commit: 0e7b984a
paths: [packages/transport/rpc_dart_isolate/lib/**]
evidence: .claude/loop/backlog/archive/B-04-isolate-future-timeout-unaudited.md
blocked_by: 
source: .claude/loop/backlog/archive/B-04-isolate-future-timeout-unaudited.md
---
...
- 0000-00-00 0e7b984a done — closed (round 223) — all four sites swept and guarded
