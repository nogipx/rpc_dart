---
id: B-28
title: metadata is exempt from flow control at both ends
state: done
commit: e481520a
...
evidence: .claude/loop/backlog/archive/B-28-metadata-is-exempt-from-flow-control.md
blocked_by: 
source: .claude/loop/backlog/archive/B-28-metadata-is-exempt-from-flow-control.md
---
...
- 0000-00-00 e481520a done — closed (round 350) — bounded the buffer; pacing was the wrong tool
