---
id: B-54
title: a bidi producer keeps running after the call has ended
state: done
commit: 2a5514ad
...
evidence: .claude/loop/backlog/archive/B-54-the-producer-runs-on-after-the-call-ends.md
blocked_by: 
source: .claude/loop/backlog/archive/B-54-the-producer-runs-on-after-the-call-ends.md
---
...
- 0000-00-00 2a5514ad done — closed (round 390) — the signal existed and was not exposed
