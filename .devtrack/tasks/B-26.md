---
id: B-26
title: `bodyReadTimeout` bounds the wait, not the body read
state: done
commit: eac7dde2
paths: [packages/transport/rpc_dart_http/lib/src/rpc_http_responder_transport.dart]
evidence: .claude/loop/backlog/archive/B-26-timeout-bounds-the-wait-not-the-body-read.md
blocked_by: 
source: .claude/loop/backlog/archive/B-26-timeout-bounds-the-wait-not-the-body-read.md
---
...
- 0000-00-00 eac7dde2 done — closed (round 273) — REFUTED
