---
id: B-83
title: the drain refusal is ordered one way, the ceiling refusal the other
state: queued
commit: 67303ea6
paths: [packages/core/rpc_dart/lib/src/endpoint/responder_pipeline.dart]
evidence: —
blocked_by: 
source: .claude/loop/backlog/B-83-the-drain-refusal-is-ordered-against-its-siblings-rule.md
---
