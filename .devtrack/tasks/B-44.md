---
id: B-44
title: a client-stream message reaches the responder with its fields empty (…
state: done
...
evidence: .claude/loop/backlog/archive/B-44-client-stream-first-frame-loses-its-metadata.md
blocked_by: 
source: .claude/loop/backlog/archive/B-44-client-stream-first-frame-loses-its-metadata.md
---
...
- 0000-00-00 bb8548939524ee67a53dcc5339d15f772e3f032e done — closed (round 383)
