---
id: B-12
title: http2: cancelling a stalled call kills the connection for good
state: done
commit: 1d5efdda
paths: [packages/transport/rpc_dart_http2/lib/**]
evidence: .claude/loop/backlog/archive/B-12-http2-cancel-kills-the-connection.md
blocked_by: 
source: .claude/loop/backlog/archive/B-12-http2-cancel-kills-the-connection.md
---
...
- 0000-00-00 1d5efdda done — closed (round 208) — option 2 shipped; the upstream report is still open
