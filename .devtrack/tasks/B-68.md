---
id: B-68
title: `IRpcServer.stop()` cannot express a drain, so `RpcApp` never asks fo…
state: done
commit: ff930001
...
evidence: .claude/loop/backlog/archive/B-68-irpcserver-stop-cannot-express-a-drain.md
blocked_by: 
source: .claude/loop/backlog/archive/B-68-irpcserver-stop-cannot-express-a-drain.md
---
