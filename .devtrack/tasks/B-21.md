---
id: B-21
title: make the reconnect capability a compile-time requirement
state: done
commit: ed1a54bc
...
evidence: .claude/loop/backlog/archive/B-21-reconnectable-transport-type.md
blocked_by: 
source: .claude/loop/backlog/archive/B-21-reconnectable-transport-type.md
---
...
- 0000-00-00 ed1a54bc done — closed (round 430)
