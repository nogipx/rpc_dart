---
id: B-20
title: the detached-future guard has no witness
state: done
commit: b8d934a2
paths: [packages/core/rpc_dart/lib/src/endpoint/responder_pipeline.dart]
evidence: .claude/loop/backlog/archive/B-20-detached-guard-has-no-witness.md
blocked_by: 
source: .claude/loop/backlog/archive/B-20-detached-guard-has-no-witness.md
---
...
- 0000-00-00 b8d934a2 done — closed (round 225)
