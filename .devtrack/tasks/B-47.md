---
id: B-47
title: the initial send window is smaller than a message
state: done
commit: b17af71c
...
evidence: .claude/loop/backlog/archive/B-47-the-initial-send-window-is-smaller-than-a-message.md
blocked_by: 
source: .claude/loop/backlog/archive/B-47-the-initial-send-window-is-smaller-than-a-message.md
---
...
- 0000-00-00 b17af71c done — closed (round 380)
