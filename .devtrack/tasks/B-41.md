---
id: B-41
title: Base64 runs on `Dispatchers.Main`, and the evidence says it is not th…
state: done
commit: 8a7e6097
paths: [packages/transport/rpc_dart_wasm/android/src/main/kotlin/com/nogipx/rpc_dart_wasm/RpcDartWasmPlugin.kt]
evidence: .claude/loop/backlog/archive/B-41-android-base64-on-the-main-thread.md
blocked_by: 
source: .claude/loop/backlog/archive/B-41-android-base64-on-the-main-thread.md
---
...
- 0000-00-00 8a7e6097 done — closed (round 415)
