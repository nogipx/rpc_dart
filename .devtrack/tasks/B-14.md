---
id: B-14
title: one stale `_fcSendCredit` entry per parked-then-abandoned upload
state: done
commit: 0d071c55
paths: [packages/core/rpc_dart/lib/src/rpc/transports/channel_transport.dart]
evidence: .claude/loop/backlog/archive/B-14-stale-sendcredit-per-abandoned-upload.md
blocked_by: 
source: .claude/loop/backlog/archive/B-14-stale-sendcredit-per-abandoned-upload.md
---
...
- 0000-00-00 0d071c55 done — closed (round 212) — mechanism pinned to a late grant, fixed
