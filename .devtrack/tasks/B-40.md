---
id: B-40
title: `_methodPathFromKey` cannot round-trip a dotted service name
state: done
commit: 7a3c66d5
paths: [packages/core/rpc_dart/lib/src/endpoint/responder_pipeline.dart]
evidence: .claude/loop/backlog/archive/B-40-method-path-from-key-drops-dots.md
blocked_by: 
source: .claude/loop/backlog/archive/B-40-method-path-from-key-drops-dots.md
---
...
- 0000-00-00 7a3c66d5 done — closed (round 420)
