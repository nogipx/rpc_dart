---
id: B-31
title: the isolate web channel has no reachable witness
state: done
commit: 6a35cb7a
paths: [packages/transport/rpc_dart_isolate/lib/src/isolate_transport_web.dart]
evidence: .claude/loop/backlog/archive/B-31-the-web-channel-has-no-reachable-witness.md
blocked_by: 
source: .claude/loop/backlog/archive/B-31-the-web-channel-has-no-reachable-witness.md
---
...
- 0000-00-00 6a35cb7a done — closed (round 428)
