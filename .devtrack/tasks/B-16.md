---
id: B-16
title: is the pre-method byte budget released on every teardown path?
state: done
commit: 359c79ad
paths: [packages/core/rpc_dart/lib/src/endpoint/responder_pipeline.dart]
evidence: .claude/loop/backlog/archive/B-16-pre-method-byte-budget-release.md
blocked_by: 
source: .claude/loop/backlog/archive/B-16-pre-method-byte-budget-release.md
---
...
- 0000-00-00 359c79ad done — closed (round 215) — swept, clean; the budget is released on every path
