---
id: B-84
title: three cleanup blocks, each clearing a different subset
state: queued
commit: 7ec1b5d1
paths: [packages/transport/rpc_dart_http2/lib/src/transports/http2/rpc_http2_caller_transport.dart]
evidence: —
blocked_by: 
source: .claude/loop/backlog/B-84-three-cleanup-blocks-with-different-subsets.md
---
...
- 2026-09-23 7ec1b5d1 ready — live-update check
- 2026-09-23 7ec1b5d1 queued — live check from the agent side
