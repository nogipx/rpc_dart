---
id: B-13
title: does an abandoned upload leave a sender parked forever?
state: done
commit: beed83e5
paths: [packages/core/rpc_dart/lib/src/rpc/transports/**]
evidence: .claude/loop/backlog/archive/B-13-parked-sender-outlives-its-call.md
blocked_by: 
source: .claude/loop/backlog/archive/B-13-parked-sender-outlives-its-call.md
---
...
- 0000-00-00 beed83e5 done — closed (round 211) — measured, the wake works: 0 waiters with it, 30 without
