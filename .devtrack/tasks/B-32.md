---
id: B-32
title: zero-copy unary may not dispatch at all — WRONG, closed
state: done
commit: 29acab93
...
evidence: .claude/loop/backlog/archive/B-32-zero-copy-unary-may-not-dispatch.md
blocked_by: 
source: .claude/loop/backlog/archive/B-32-zero-copy-unary-may-not-dispatch.md
---
...
- 0000-00-00 29acab93 done — closed (round 415)
