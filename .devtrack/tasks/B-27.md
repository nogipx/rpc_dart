---
id: B-27
title: a TCP SYN builds an endpoint and runs the application's callback
state: done
commit: 508fba09
paths: [packages/transport/rpc_dart_http2/lib/src/transports/http2/rpc_http2_server.dart]
evidence: .claude/loop/backlog/archive/B-27-a-tcp-syn-builds-an-endpoint.md
blocked_by: 
source: .claude/loop/backlog/archive/B-27-a-tcp-syn-builds-an-endpoint.md
---
...
- 0000-00-00 508fba09 done — closed (round 287)
