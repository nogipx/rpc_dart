---
id: B-38
title: the iOS recv loop gives up silently, and Android already fixed this
state: waiting
commit: 7ec1b5d1
paths: [packages/transport/rpc_dart_wasm/ios/Classes/RpcDartWasmPlugin.swift]
evidence: packages/transport/rpc_dart_wasm/example/wasm_guest/main.dart
blocked_by: test
source: .claude/loop/backlog/B-38-ios-recv-loop-dies-silently.md
---
...
- 0000-00-00 0f05352a ready — импортировано из evidence-loop, не перемеряно
- 2026-09-23 7ec1b5d1 waiting — нужен симулятор, загрузите и раунд закроется
- 2026-09-23 7ec1b5d1 active — simulator is up, taking it
- 2026-09-23 7ec1b5d1 waiting — re-block
