---
id: B-53
title: an HTTP/2 stream reset that races in-flight responses kills the conne…
state: done
commit: 69d24a76
paths: [packages/transport/rpc_dart_http2/lib/**, packages/core/rpc_dart/lib/src/rpc/streams/base_processor.dart]
evidence: .claude/loop/backlog/archive/B-53-an-http2-reset-racing-responses-kills-the-connection.md
blocked_by: 
source: .claude/loop/backlog/archive/B-53-an-http2-reset-racing-responses-kills-the-connection.md
---
...
- 0000-00-00 69d24a76 done — closed (round 398) — the ordinary half fixed in 388, the rest by http2 3.1.0
