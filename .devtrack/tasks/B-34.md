---
id: B-34
title: http2 is the only transport that does not check outbound metadata
state: done
commit: e63e551b
...
evidence: .claude/loop/backlog/archive/B-34-http2-does-not-check-outbound-metadata.md
blocked_by: 
source: .claude/loop/backlog/archive/B-34-http2-does-not-check-outbound-metadata.md
---
...
- 0000-00-00 e63e551b done — closed (round 340) — fixed with the two lines rpc_dart_http already has
