---
id: B-45
title: the server and the framework both start every endpoint, and say so 70…
state: done
...
evidence: .claude/loop/backlog/archive/B-45-two-owners-start-the-same-endpoint.md
blocked_by: 
source: .claude/loop/backlog/archive/B-45-two-owners-start-the-same-endpoint.md
---
...
- 0000-00-00 bb8548939524ee67a53dcc5339d15f772e3f032e done — closed (round 366)
